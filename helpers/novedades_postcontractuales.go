...
func ConstruirNovedadOtroSi(novedadRes models.NovedadPoscontractual) (novedaux models.Noveda, outputError map[string]interface{}) {
	...
	// 		switch idTipo {
	// 		case 5:
	// 			novedaux.FechaCreacion = ""
	// 		}
	// 	}
	// } else {
	// 	fmt.Println(err) // ! Manejar este error
	// }
