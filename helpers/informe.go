...
func Informe(pago_mensual_id string) (informe []models.Informe, outputError map[string]interface{}) {
	...
	if response, err := request.GetJsonTest2(beego.AppConfig.String("UrlCrudCumplidos")+"/informe/?query="+query, &respuesta_peticion); (err == nil) && (response == 200) {
...
func GetActividadesEspecificas(idInforme string) (actividades_especificas []models.ActividadEspecifica, outputError map[string]interface{}) {
	...
	if response, err := request.GetJsonTest2(beego.AppConfig.String("UrlCrudCumplidos")+"/actividad_especifica/?query="+query+"&limit=-1&sortby=FechaCreacion&order=asc", &respuesta_peticion); (err == nil) && (response == 200) {
		if len(respuesta_peticion["Data"].([]interface{})[0].(map[string]interface{})) != 0 {
...
func GetActividadesRealizadas(idActividadEspecifica string) (actividades_realizadas []models.ActividadRealizada, outputError map[string]interface{}) {
	...
	if response, err := request.GetJsonTest2(beego.AppConfig.String("UrlCrudCumplidos")+"/actividad_realizada/?query="+query+"&limit=-1&sortby=FechaCreacion&order=asc", &respuesta_peticion); (err == nil) && (response == 200) {
		if len(respuesta_peticion["Data"].([]interface{})[0].(map[string]interface{})) != 0 {
...
func AddInforme(informe models.Informe) (response map[string]interface{}, outputError map[string]interface{}) {
	...
	if err := request.SendJson(beego.AppConfig.String("UrlCrudCumplidos")+"/informe", "POST", &res, informe_creado); err == nil {
...
func AddActividadEspecifica(actividad_especifica map[string]interface{}) (actividad_especifica_creada models.ActividadEspecifica, outputError map[string]interface{}) {
	...
	if err := request.SendJson(beego.AppConfig.String("UrlCrudCumplidos")+"/actividad_especifica", "POST", &response, actividad_especifica); err == nil {
...
func AddActividadRealizada(actividad_realizada map[string]interface{}) (actividad_realizada_creada models.ActividadRealizada, outputError map[string]interface{}) {
	...
	var response map[string]interface{}
	if err := request.SendJson(beego.AppConfig.String("UrlCrudCumplidos")+"/actividad_realizada", "POST", &response, actividad_realizada); err == nil {
...
func UpdateInformeById(informe models.Informe) (outputError map[string]interface{}) {
	...
	if err := request.SendJson(beego.AppConfig.String("UrlCrudCumplidos")+"/informe/"+id, "PUT", &res, informe_Actualizado); err == nil {
		query := "informeid:" + id
		...
		if response, err := request.GetJsonTest2(beego.AppConfig.String("UrlCrudCumplidos")+"/actividad_especifica/?query="+query+"&limit=-1&sortby=FechaCreacion&order=asc", &respuesta_peticion); (err == nil) && (response == 200) {
			if len(respuesta_peticion["Data"].([]interface{})[0].(map[string]interface{})) != 0 {
				...
				for _, actEsp := range actividades_especificas {
					idactEsp := strconv.Itoa(actEsp.Id)
					if err := request.SendJson(beego.AppConfig.String("UrlCrudCumplidos")+"/actividad_especifica/"+idactEsp, "DELETE", &res, informe_Actualizado); err == nil {
					}
				}
			}
		}
...
func UltimoInformeContratista(pago_mensual_id string) (informe []models.Informe, outputError map[string]interface{}) {
	...
	if response, err := request.GetJsonTest2(beego.AppConfig.String("UrlCrudCumplidos")+"/pago_mensual/?query=Id:"+pago_mensual_id, &respuesta_peticion); (err == nil) && (response == 200) {
		...
		if len(pagos_mensuales) > 0 {
			...
			if response, err := request.GetJsonTest2(beego.AppConfig.String("UrlCrudCumplidos")+"/informe/?query="+query+sortby+order+limit, &respuesta_peticion); (err == nil) && (response == 200) {
				if len(respuesta_peticion["Data"].([]interface{})[0].(map[string]interface{})) != 0 {
